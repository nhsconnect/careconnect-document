...
const routes: Routes = [
  ...
  { path: 'doc/:patientId',canActivate: [AuthGuard], component: ViewDocumentComponent},
  { path: 'pdf/:patientId',canActivate: [AuthGuard], component: PdfViewerComponent},
  { path: 'img/:patientId',canActivate: [AuthGuard], component: ImgViewerComponent},
