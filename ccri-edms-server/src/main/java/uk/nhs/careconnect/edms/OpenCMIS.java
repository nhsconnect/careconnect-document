...
public class OpenCMIS {
    ...
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(OpenCMIS.class);


    private static Map<String, Session> connections = new ConcurrentHashMap<>();

    private static String SECONDARY_OBJECT_TYPE_IDS_PROP_NAME = null;
    ...
    public Session getSession(String connectionName, String username, String pwd) {
        ...
        if (session == null) {
            ...
            parameters.put(SessionParameter.ATOMPUB_URL,
                    "http://localhost:8282/alfresco/api/-default-/cmis/versions/1.1/atom");
