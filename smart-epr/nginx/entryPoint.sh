...
sed -i "s/KEYCLOAK_CLIENT_SECRET/$KEYCLOAK_CLIENT_SECRET/g" /usr/share/nginx/html/smart/main.js

sed -i "s/KEYCLOAK_CLIENT_ID/$KEYCLOAK_CLIENT_ID/g" /usr/share/nginx/html/smart/main.js

sed -i "s/KEYCLOAK_REALM/$KEYCLOAK_REALM/g" /usr/share/nginx/html/smart/main.js

sed -i "s~KEYCLOAK_AUTH_URL~$KEYCLOAK_AUTH_URL~g" /usr/share/nginx/html/smart/main.js

sed -i "s~KEYCLOAK_SERVER_URL~$KEYCLOAK_SERVER_URL~g" /usr/share/nginx/html/smart/main.js
