...
public class ConformanceProvider implements IServerConformanceProvider<CapabilityStatement> {
    ...
    public ConformanceProvider(String oauth2authorize
            , String oauth2token
    ...
    public ConformanceProvider(ApplicationContext applicationContext) {
        this.context = applicationContext.getBean(CamelContext.class);
    ...
    private static final Logger log = LoggerFactory.getLogger(ConformanceProvider.class);
