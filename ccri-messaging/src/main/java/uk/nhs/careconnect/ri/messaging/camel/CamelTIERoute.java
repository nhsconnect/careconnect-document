 ...
 */
@Component
public class CamelTIERoute extends RouteBuilder {
    ...
    public void configure()
    {
        ...
        from("direct:HAPIServer")
                ...
                .to("log:uk.nhs.careconnect.messaging.start?level=INFO&showHeaders=true&showExchangeId=true")
                .to(eprBase)
                .process(camelPostProcessor)
                .to("log:uk.nhs.careconnect.messaging.complete?level=INFO&showHeaders=true&showExchangeId=true")
